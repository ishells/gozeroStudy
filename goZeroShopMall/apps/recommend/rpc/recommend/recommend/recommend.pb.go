...
var file_recommend_proto_rawDesc = []byte{
	...
	0x6f, 0x12, 0x09, 0x72, 0x65, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x64, 0x22, 0x1d, 0x0a, 0x07,
	...
	0x65, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x64, 0x12, 0x2f, 0x0a, 0x04, 0x50, 0x69, 0x6e, 0x67,
	0x12, 0x12, 0x2e, 0x72, 0x65, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x64, 0x2e, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x1a, 0x13, 0x2e, 0x72, 0x65, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x64,
...
var file_recommend_proto_goTypes = []any{
	(*Request)(nil),  // 0: recommend.Request
	(*Response)(nil), // 1: recommend.Response
}
var file_recommend_proto_depIdxs = []int32{
	0, // 0: recommend.Recommend.Ping:input_type -> recommend.Request
	1, // 1: recommend.Recommend.Ping:output_type -> recommend.Response
...
func file_recommend_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_recommend_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_recommend_proto_msgTypes[1].Exporter = func(v any, i int) any {
